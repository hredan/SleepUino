/*
  ...
  Information and contribution at https://www.sleepuino.de/.
...
HandleDisplay::HandleDisplay() {
  ...
  snprintf(_timeStr, MAX_CHARACTOR_TIME_STR, "00:00");
}
...
bool HandleDisplay::getEnableDisplay() { return _enableDisplay; }
...
void HandleDisplay::setTime(char *timeStr) {
  if (strncmp(timeStr, _timeStr, 5) != 0) {
    sniprintf(_timeStr, MAX_CHARACTOR_TIME_STR, timeStr);
    Serial.printf("update _timeStr: %s\n", _timeStr);
    updateDisplay();
  }
}

void HandleDisplay::begin() { _u8g2->begin(); }
