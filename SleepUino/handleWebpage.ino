...
void HandleWebpage::setCallBackGetTime(CallBackGetTime callBackGetTime)
{
  _callBackGetTime = callBackGetTime;
}
...
void HandleWebpage::setLEDMoon()
{  
  setLED(LED_MOON_PIN);
}

void HandleWebpage::setLEDSun(){
  setLED(LED_SUN_PIN);
}
